...
#choose dataframe for figures and tables below: 
...
ts_wa <- events1819(plotTS(df=df_wa,  mode="percent_abs", title="Washington - absolute percentage"))
if(total=="all"){
...
if(total=="all"){
  ts_or <- events1819(plotTS(df=df_or, mode="percent_abs", title="Oregon",  limits=c(-0.01,0.13)))
} else { 
